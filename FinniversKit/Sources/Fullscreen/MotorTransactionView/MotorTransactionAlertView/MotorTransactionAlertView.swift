...
public class MotorTransactionAlertView: UIView {
    enum Icon: String {
    ...
    private var model: MotorTransactionAlertViewModel

    public init(withAutoLayout autoLayout: Bool = false, model: MotorTransactionAlertViewModel) {
        self.model = model
    ...
    private func setup() {
        ...
        NSLayoutConstraint.activate([
            ...
            iconImageView.widthAnchor.constraint(equalToConstant: MotorTransactionAlertView.iconImageSize),
