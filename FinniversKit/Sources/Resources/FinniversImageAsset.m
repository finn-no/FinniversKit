...
NSString *const FinniversImageAssetbetaPill = @"betaPill";
...
NSString *const FinniversImageAssetmultipleContracts = @"multipleContracts";
...
NSString *const FinniversImageAssetvideoChat = @"videoChat";
...
+ (NSArray<NSString *> *)finniversImageNames {
    return @[
             ...
             FinniversImageAssetmultipleContracts,
