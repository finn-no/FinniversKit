...
public class ToastView: UIView {
    ...
    public var image: UIImage? {
        get {
            guard let image = imageView.image else {
                switch style {
                case .error, .errorButton: return UIImage(named: .exclamationMarkTriangleMini)
    ...
    private func setup() {
        ...
        NSLayoutConstraint.activate([
            ...
            messageTitle.leadingAnchor.constraint(equalTo: imageView.trailingAnchor, constant: Warp.Spacing.spacing200),
        ...
        if style == .successButton || style == .errorButton {
            ...
            NSLayoutConstraint.activate([
                messageTitle.trailingAnchor.constraint(lessThanOrEqualTo: actionButton.leadingAnchor, constant: -Warp.Spacing.spacing200),
