...
class ContractActionDemoView: UIView {
    ...
    private func setup() {
        ...
        NSLayoutConstraint.activate([
            contractActionView.leadingAnchor.constraint(equalTo: leadingAnchor, constant: .mediumSpacing),
            contractActionView.trailingAnchor.constraint(equalTo: trailingAnchor, constant: -.mediumSpacing),
