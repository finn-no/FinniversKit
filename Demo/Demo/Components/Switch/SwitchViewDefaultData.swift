...
extension SwitchViewDefaultModel {
    static var demoViewModel1 = SwitchViewDefaultModel.init(
        title: "Anbefalinger",
        detail: "Vi gir deg relevante tips på forsiden",
        initialSwitchValue: true
    )

    static var demoViewModel2 = SwitchViewDefaultModel.init(
        title: "Smart reklame",
        detail: "Vi leter for deg når du gjør andre ting",
        initialSwitchValue: false
    )

    static var demoViewModel3 = SwitchViewDefaultModel.init(
        title: "Annen styling",
