     ...
     private var sections = [
        ...
        SettingsSection(
            ...
            items: [
                ...
                SettingsIconItem(title: "Personvernerklæring", icon: (image: .init(systemName: "square.and.arrow.up")!, tintColor: .textSubtle)) // swiftlint:disable:this force_unwrapping
            ],
            footerTitle: nil
        )
    ]
