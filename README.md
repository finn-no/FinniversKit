<p align="center"><img width=100% src="https://raw.githubusercontent.com/finn-no/Munch/master/GitHub/cover-v3.png"></p>
...
Munch is the iOS native implementation of FINN's design system. [You can find the reference here](http://finnivers.finn.no/d/2koIuZwTP5cy/design-system). This framework is composed of small components that are meant to be used as building blocks of the FINN iOS app. 
...
<p align="center"><img width=100% src="https://raw.githubusercontent.com/finn-no/Munch/master/GitHub/demo.png"></p>
...
``` Swift
UIFont.registerMunchFonts()
```

## License

**Munch** is available under the Apache License 2.0. See the [LICENSE file](/LICENSE.md) for more info.
