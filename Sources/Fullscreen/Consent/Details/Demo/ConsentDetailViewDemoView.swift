...
class ConsentDetailViewDemoView: UIView {
    ...
    private let detailModel = ConsentDetailViewModel(heading: "Få nyhetsbrev fra FINN", definition: "FINN sender deg nyhetsbrev med for eksempel reisetips, jobbtrender, morsomme konkurranser og smarte råd til deg som kjøper og selger.\nFor å gjøre dette bruker vi kontaktinformasjonen knyttet til brukeren din på FINN.", indexPath: IndexPath(row: 0, section: 0))
