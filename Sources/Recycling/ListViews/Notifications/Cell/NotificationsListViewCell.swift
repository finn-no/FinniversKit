...
public protocol NotificationsListViewCellDataSource {
...
public class NotificationsListViewCell: UICollectionViewCell {
    ...
    private lazy var imageDesciptionView: UIView = {
        ...
        view.alpha = 1.0
        view.layer.cornerRadius = NotificationsListViewCell.cornerRadius
    ...
    public var dataSource: NotificationsListViewCellDataSource?
    ...
    private func setup() {
        ...
        NSLayoutConstraint.activate([
            ...
            subTitleLabel.topAnchor.constraint(equalTo: imageView.bottomAnchor, constant: NotificationsListViewCell.subtitleTopMargin),
            subTitleLabel.leadingAnchor.constraint(equalTo: leadingAnchor),
            subTitleLabel.trailingAnchor.constraint(equalTo: trailingAnchor),
            subTitleLabel.heightAnchor.constraint(equalToConstant: NotificationsListViewCell.subtitleHeight),

            titleLabel.topAnchor.constraint(equalTo: subTitleLabel.bottomAnchor, constant: NotificationsListViewCell.titleTopMargin),
            titleLabel.leadingAnchor.constraint(equalTo: leadingAnchor),
            titleLabel.trailingAnchor.constraint(equalTo: trailingAnchor),
            titleLabel.heightAnchor.constraint(equalToConstant: NotificationsListViewCell.titleHeight),
            titleLabel.bottomAnchor.constraint(equalTo: bottomAnchor, constant: -NotificationsListViewCell.titleBottomMargin),

            iconImageView.leadingAnchor.constraint(equalTo: imageDesciptionView.leadingAnchor, constant: NotificationsListViewCell.margin),
            iconImageView.heightAnchor.constraint(equalToConstant: NotificationsListViewCell.iconSize),
            iconImageView.widthAnchor.constraint(equalToConstant: NotificationsListViewCell.iconSize),
            iconImageView.centerYAnchor.constraint(equalTo: imageDesciptionView.centerYAnchor),

            imageTextLabel.leadingAnchor.constraint(equalTo: iconImageView.trailingAnchor, constant: NotificationsListViewCell.margin),
            ...
            imageDesciptionView.trailingAnchor.constraint(equalTo: imageTextLabel.trailingAnchor, constant: NotificationsListViewCell.margin),
            imageDesciptionView.trailingAnchor.constraint(lessThanOrEqualTo: trailingAnchor),
            imageDesciptionView.heightAnchor.constraint(equalToConstant: NotificationsListViewCell.imageDescriptionHeight),
    ...
    public override func prepareForReuse() {
        ...
        if let model = model {
            dataSource?.notificationsListViewCell(self, cancelLoadingImageForModel: model, imageWidth: imageView.frame.size.width)
        }
    }
