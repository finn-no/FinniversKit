...
final class UserAdDetailsView: UIView {
    ...
    private lazy var adImageWidthConstraint = adImageView.widthAnchor.constraint(equalToConstant: UserAdCellStyle.default.imageSize)
    private lazy var adImageHeightConstraint = adImageView.heightAnchor.constraint(equalToConstant: UserAdCellStyle.default.imageSize)
    ...
    func configure(with style: UserAdCellStyle, model: UserAdTableViewCellViewModel) {
        self.model = model
    ...
    func loadImage() {
        ...
        adImageView.loadImage(
            for: imagePath,
            imageWidth: UserAdCellStyle.default.imageSize,
