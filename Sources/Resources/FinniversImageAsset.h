...
extern NSString *const FinniversImageAssetfavoritesEditList;
extern NSString *const FinniversImageAssetfavoritesEditName;
...
extern NSString *const FinniversImageAssetfavoritesSortLastUpdated;
